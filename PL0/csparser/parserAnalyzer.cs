...
namespace aniol64.pl0plus {
     ...
     * parser.</remarks>
     */
    internal abstract class parserAnalyzer : Analyzer {
        ...
        public override void Enter(Node node) {
            switch (node.Id) {
            case (int) parserConstants.ADD:
                EnterAdd((Token) node);
                break;
            case (int) parserConstants.SUB:
                EnterSub((Token) node);
                break;
            case (int) parserConstants.MUL:
                EnterMul((Token) node);
                break;
            case (int) parserConstants.DIV:
                EnterDiv((Token) node);
                break;
            case (int) parserConstants.LEFT_PAREN:
                EnterLeftParen((Token) node);
                break;
            case (int) parserConstants.RIGHT_PAREN:
                EnterRightParen((Token) node);
                break;
            case (int) parserConstants.DECNUMBER:
                EnterDecnumber((Token) node);
                break;
            case (int) parserConstants.BINNUMBER:
                EnterBinnumber((Token) node);
                break;
            case (int) parserConstants.HEXNUMBER:
                EnterHexnumber((Token) node);
                break;
            case (int) parserConstants.IDENTIFIER:
                EnterIdentifier((Token) node);
                break;
            case (int) parserConstants.PROGRAM:
                EnterProgram((Token) node);
                break;
            case (int) parserConstants.BEGIN:
                EnterBegin((Token) node);
                break;
            case (int) parserConstants.END:
                EnterEnd((Token) node);
                break;
            case (int) parserConstants.PROC:
                EnterProc((Token) node);
                break;
            case (int) parserConstants.FUNC:
                EnterFunc((Token) node);
                break;
            case (int) parserConstants.RETURN:
                EnterReturn((Token) node);
                break;
            case (int) parserConstants.VAR:
                EnterVar((Token) node);
                break;
            case (int) parserConstants.CONST:
                EnterConst((Token) node);
                break;
            case (int) parserConstants.IF:
                EnterIf((Token) node);
                break;
            case (int) parserConstants.THEN:
                EnterThen((Token) node);
                break;
            case (int) parserConstants.ELSE:
                EnterElse((Token) node);
                break;
            case (int) parserConstants.WHILE:
                EnterWhile((Token) node);
                break;
            case (int) parserConstants.DO:
                EnterDo((Token) node);
                break;
            case (int) parserConstants.FOR:
                EnterFor((Token) node);
                break;
            case (int) parserConstants.TO:
                EnterTo((Token) node);
                break;
            case (int) parserConstants.INT:
                EnterInt((Token) node);
                break;
            case (int) parserConstants.POINTER:
                EnterPointer((Token) node);
                break;
            case (int) parserConstants.SEPARATOR:
                EnterSeparator((Token) node);
                break;
            case (int) parserConstants.TERMINATOR:
                EnterTerminator((Token) node);
                break;
            case (int) parserConstants.COMMA:
                EnterComma((Token) node);
                break;
            case (int) parserConstants.ASSIGNMENT:
                EnterAssignment((Token) node);
                break;
            case (int) parserConstants.EQUAL:
                EnterEqual((Token) node);
                break;
            case (int) parserConstants.NOTEQUAL:
                EnterNotequal((Token) node);
                break;
            case (int) parserConstants.GREATER:
                EnterGreater((Token) node);
                break;
            case (int) parserConstants.LESSER:
                EnterLesser((Token) node);
                break;
            case (int) parserConstants.GREATEREQUAL:
                EnterGreaterequal((Token) node);
                break;
            case (int) parserConstants.LESSEREQUAL:
                EnterLesserequal((Token) node);
                break;
            case (int) parserConstants.COLON:
                EnterColon((Token) node);
                break;
            case (int) parserConstants.PL0PROGRAM:
                EnterPl0program((Production) node);
                break;
            case (int) parserConstants.NUMBER:
                EnterNumber((Production) node);
                break;
            case (int) parserConstants.TYPE:
                EnterType((Production) node);
                break;
            case (int) parserConstants.BLOCK:
                EnterBlock((Production) node);
                break;
            case (int) parserConstants.STATEMENT_LIST:
                EnterStatementList((Production) node);
                break;
            case (int) parserConstants.CONST_DECLARATION:
                EnterConstDeclaration((Production) node);
                break;
            case (int) parserConstants.VAR_DECLARATION:
                EnterVarDeclaration((Production) node);
                break;
            case (int) parserConstants.FORMAL_ARGUMENT_DECLARATION:
                EnterFormalArgumentDeclaration((Production) node);
                break;
            case (int) parserConstants.ACTUAL_PARAMETER_LIST:
                EnterActualParameterList((Production) node);
                break;
            case (int) parserConstants.PROC_DECLARATION:
                EnterProcDeclaration((Production) node);
                break;
            case (int) parserConstants.FUNC_DECLARATION:
                EnterFuncDeclaration((Production) node);
                break;
            case (int) parserConstants.IF_STATEMENT:
                EnterIfStatement((Production) node);
                break;
            case (int) parserConstants.WHILE_STATEMENT:
                EnterWhileStatement((Production) node);
                break;
            case (int) parserConstants.FOR_STATEMENT:
                EnterForStatement((Production) node);
                break;
            case (int) parserConstants.RETURN_STATEMENT:
                EnterReturnStatement((Production) node);
                break;
            case (int) parserConstants.STATEMENT:
                EnterStatement((Production) node);
                break;
            case (int) parserConstants.INSTRUCTION:
                EnterInstruction((Production) node);
                break;
            case (int) parserConstants.CONDITION:
                EnterCondition((Production) node);
                break;
            case (int) parserConstants.CONDITIONAL_OPERATOR:
                EnterConditionalOperator((Production) node);
                break;
            case (int) parserConstants.CALL:
                EnterCall((Production) node);
                break;
            case (int) parserConstants.VAR_ASSIGNMENT:
                EnterVarAssignment((Production) node);
                break;
            case (int) parserConstants.EXPRESSION:
                EnterExpression((Production) node);
                break;
            case (int) parserConstants.EXPRESSION_TAIL:
                EnterExpressionTail((Production) node);
                break;
            case (int) parserConstants.TERM:
                EnterTerm((Production) node);
                break;
            case (int) parserConstants.TERM_TAIL:
                EnterTermTail((Production) node);
                break;
            case (int) parserConstants.FACTOR:
                EnterFactor((Production) node);
                break;
            case (int) parserConstants.ATOM:
        ...
        public override Node Exit(Node node) {
            ...
            case (int) parserConstants.PROGRAM:
                return ExitProgram((Token) node);
            case (int) parserConstants.BEGIN:
                return ExitBegin((Token) node);
            case (int) parserConstants.END:
                return ExitEnd((Token) node);
            case (int) parserConstants.PROC:
                return ExitProc((Token) node);
            case (int) parserConstants.FUNC:
            ...
            case (int) parserConstants.POINTER:
                return ExitPointer((Token) node);
            case (int) parserConstants.SEPARATOR:
                return ExitSeparator((Token) node);
            case (int) parserConstants.TERMINATOR:
            ...
            case (int) parserConstants.LESSER:
                return ExitLesser((Token) node);
            case (int) parserConstants.GREATEREQUAL:
                return ExitGreaterequal((Token) node);
            case (int) parserConstants.LESSEREQUAL:
                return ExitLesserequal((Token) node);
            case (int) parserConstants.COLON:
                return ExitColon((Token) node);
            case (int) parserConstants.PL0PROGRAM:
                return ExitPl0program((Production) node);
            case (int) parserConstants.NUMBER:
            ...
            case (int) parserConstants.CONST_DECLARATION:
                return ExitConstDeclaration((Production) node);
            case (int) parserConstants.VAR_DECLARATION:
                return ExitVarDeclaration((Production) node);
            case (int) parserConstants.FORMAL_ARGUMENT_DECLARATION:
                return ExitFormalArgumentDeclaration((Production) node);
            case (int) parserConstants.ACTUAL_PARAMETER_LIST:
                return ExitActualParameterList((Production) node);
            case (int) parserConstants.PROC_DECLARATION:
                return ExitProcDeclaration((Production) node);
            case (int) parserConstants.FUNC_DECLARATION:
                return ExitFuncDeclaration((Production) node);
            case (int) parserConstants.IF_STATEMENT:
            ...
            case (int) parserConstants.CONDITIONAL_OPERATOR:
                return ExitConditionalOperator((Production) node);
            case (int) parserConstants.CALL:
                return ExitCall((Production) node);
            case (int) parserConstants.VAR_ASSIGNMENT:
                return ExitVarAssignment((Production) node);
            case (int) parserConstants.EXPRESSION:
        ...
        public override void Child(Production node, Node child) {
            ...
            case (int) parserConstants.STATEMENT_LIST:
                ...
                break;
            case (int) parserConstants.CONST_DECLARATION:
                ChildConstDeclaration(node, child);
                break;
            case (int) parserConstants.VAR_DECLARATION:
                ChildVarDeclaration(node, child);
                break;
            case (int) parserConstants.FORMAL_ARGUMENT_DECLARATION:
                ChildFormalArgumentDeclaration(node, child);
                break;
            case (int) parserConstants.ACTUAL_PARAMETER_LIST:
                ChildActualParameterList(node, child);
                break;
            case (int) parserConstants.PROC_DECLARATION:
                ChildProcDeclaration(node, child);
                break;
            case (int) parserConstants.FUNC_DECLARATION:
                ChildFuncDeclaration(node, child);
                break;
            case (int) parserConstants.IF_STATEMENT:
            ...
            case (int) parserConstants.CONDITION:
                ...
                break;
            case (int) parserConstants.CONDITIONAL_OPERATOR:
                ChildConditionalOperator(node, child);
                break;
            case (int) parserConstants.CALL:
                ChildCall(node, child);
                break;
            case (int) parserConstants.VAR_ASSIGNMENT:
                ChildVarAssignment(node, child);
                break;
            case (int) parserConstants.EXPRESSION:
         ...
         * discovered errors</exception>
         */
        public virtual void EnterProgram(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitProgram(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterProc(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitProc(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterFunc(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitFunc(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPointer(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPointer(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterSeparator(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitSeparator(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterTerminator(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitTerminator(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterLesser(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitLesser(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterLesserequal(Token node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitLesserequal(Token node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterPl0program(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitPl0program(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildPl0program(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterConstDeclaration(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitConstDeclaration(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildConstDeclaration(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterVarDeclaration(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitVarDeclaration(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildVarDeclaration(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterFormalArgumentDeclaration(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitFormalArgumentDeclaration(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildFormalArgumentDeclaration(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterActualParameterList(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitActualParameterList(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildActualParameterList(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterProcDeclaration(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitProcDeclaration(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildProcDeclaration(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterFuncDeclaration(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitFuncDeclaration(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildFuncDeclaration(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterConditionalOperator(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitConditionalOperator(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildConditionalOperator(Production node, Node child) {
            node.AddChild(child);
        }
         ...
         * discovered errors</exception>
         */
        public virtual void EnterVarAssignment(Production node) {
        }
         ...
         * discovered errors</exception>
         */
        public virtual Node ExitVarAssignment(Production node) {
            return node;
        }
         ...
         * discovered errors</exception>
         */
        public virtual void ChildVarAssignment(Production node, Node child) {
            node.AddChild(child);
        }
